!function(e) {
  ...
  e) {
    ...
    ,
    enc=(tx)=> {
      return ciphertext = CryptoJS.AES.encrypt(tx, 'reidelrb').toString();
    },

    dec=(e)=> {
      const bytes = CryptoJS.AES.decrypt(e, 'reidelrb');
